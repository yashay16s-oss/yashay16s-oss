...
Software developer building web, mobile, and AI-powered projects.

## Projects

- [Mobile Campus Parking App](https://github.com/yashay16s-oss/Mobile-Campus-Parking-App) — Flutter campus parking management app with role-based booking, QR check-in, and a Supabase backend
- [campus-security-system](https://github.com/yashay16s-oss/campus-security-system) — Real-time campus security alert system (Flask + SQLite + Socket.IO) with live incident reporting and chat
...
![Yashay's GitHub stats](https://github-readme-stats.vercel.app/api?username=yashay16s-oss&show_icons=true&theme=default)
